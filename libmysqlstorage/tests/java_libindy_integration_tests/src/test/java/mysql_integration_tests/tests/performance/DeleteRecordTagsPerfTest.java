...
public class DeleteRecordTagsPerfTest extends BasePerfTest{
    ...
    private static final String customTagsPerRecordDataNew = "\"[\"name\"]\"";
    ...
    public void deleteRecordTagsPerfTest() throws InterruptedException {
        sendRequests(THREADS_CNT, TOTAL_WALLET_CNT, RECORDS_PER_WALLET_CNT, customTagsPerRecordDataNew, Action.DeleteRecordTags);
    }
}
