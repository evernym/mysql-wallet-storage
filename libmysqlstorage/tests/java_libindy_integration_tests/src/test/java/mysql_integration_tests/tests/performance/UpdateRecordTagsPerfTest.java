...
public class UpdateRecordTagsPerfTest extends BasePerfTest{
    ...
    private static final String customTagsPerRecordDataOld = "{\"name\": \"John\", \"surname\": \"Doe\"}";
    private static final String customTagsPerRecordDataNew = "{\"name\": \"UpdatedName\", \"surname\": \"UpdatedSurname\"}";
    ...
    @Test()
    public void updateRecordTagsPerfTest() throws InterruptedException {
        sendRequests(THREADS_CNT, TOTAL_WALLET_CNT, RECORDS_PER_WALLET_CNT, customTagsPerRecordDataNew, Action.UpdateRecordTags);
    }
}
