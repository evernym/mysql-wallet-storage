...
public class DeleteRecordPerfTest extends BasePerfTest{
    ...
    @Test()
    public void deleteRecordPerfTest() throws InterruptedException {
        sendRequests(THREADS_CNT, TOTAL_WALLET_CNT, RECORDS_PER_WALLET_CNT, "", Action.DeleteRecord);
    }
}
