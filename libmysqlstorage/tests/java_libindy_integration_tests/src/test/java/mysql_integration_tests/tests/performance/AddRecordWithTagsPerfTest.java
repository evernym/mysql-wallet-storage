...
public class AddRecordWithTagsPerfTest extends BasePerfTest{
    ...
    public void prepareDB() throws Exception {
        populateDatabase(DB_THREADS_CNT, TOTAL_WALLET_CNT, 0,"", PERCENT_OF_CUSTOM_TAGS_PER_RECORD);
    }

    @Test()
    public void addRecordWithTagsPerfTest() throws InterruptedException {
        sendRequests(THREADS_CNT, TOTAL_WALLET_CNT, RECORDS_PER_WALLET_CNT, customTagsPerRecordData, Action.AddRecord);
    }
}
